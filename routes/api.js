// routes/api.js - API routes for TikTok data
...
// Helper to run the Apify scraper
  ...
  return items
    ...
    .map((item) => ({
      ...
      creator: {
        ...
        avatar: item.authorMeta?.avatar || '/images/default-avatar.png',
      },
...
function mapProfile(authorMeta) {
  ...
  return {
    ...
    avatar: authorMeta.avatar || '/images/default-avatar.png',
